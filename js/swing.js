...
(function() {
  ...
  // spring from its rest point or `endValue` as defined by [Hookefs
  // law](http://en.wikipedia.org/wiki/Hooke's_law). Springs also have
  // configurable friction, which ensures that they do not oscillate
  // infinitely. When a Spring is displaced by updating itfs resting
  ...
  util.extend(Spring.prototype, {
    ...
    // Get the absolute distance of the Spring from itfs resting endValue position.
    ...
    // Check if the Spring is atRest meaning that itfs currentValue and
